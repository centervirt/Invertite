...
BEGIN
  ...
  (q1_id, 1, '¿Quién actúa como agente superavitario (el que tiene excedente de dinero para invertir) en el mercado?', 
   '["El Estado emitiendo bonos", "Las empresas emitiendo Obligaciones Negociables", "El inversor individual con sus ahorros", "La Comisión Nacional de Valores (CNV)"]', 
   2, 'Los agentes superavitarios son aquellos individuos o familias que tienen ingresos mayores a sus gastos, generando un excedente (ahorro) que canalizan al mercado buscando rentabilidad.'),
  (q1_id, 2, '¿Cuál de estas opciones describe la función principal de las empresas y el Estado como agentes deficitarios?', 
   '["Guardar el dinero de sus ventas cotidianas", "Conseguir financiamiento para proyectos o crecimiento mediante deuda o acciones", "Controlar el tipo de cambio del dólar oficial", "Supervisar que los ciudadanos paguen sus impuestos"]', 
   1, 'Las empresas y el Estado recurren al mercado de capitales como agentes deficitarios para captar el ahorro de los inversores y financiar sus actividades productivas o de infraestructura.'),
